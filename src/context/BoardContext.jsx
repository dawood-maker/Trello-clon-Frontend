...
//   // =============================================
//   // ADD BOARD  User ka name + color MongoDB mein
//   // =============================================
...
//   // =============================================
//   // DRAG END — Column reorder + Card move
//   // =============================================
...
//       const isColumn = board.columnOrder.includes(activeId);
...
//       const destColId = board.columns[overId]?.id || allCards[overId]?.columnId;
...
//         await silentRefresh();
//       } catch (err) {
//         console.error("[BoardContext] card drag error:", err.message);
//       }
//     },
